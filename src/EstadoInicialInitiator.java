...
public class EstadoInicialInitiator extends Behaviour {
    ...
    public void action() {
        ...
        this.getDataStore().put("mensaje propose", req);
        this.getDataStore().put("responder",new AID("AgenteResponder", AID.ISLOCALNAME));
